...
CREATE TABLE IF NOT EXISTS `dbsistema`.`ingreso` (
  `idingreso` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dbsistema`.`detalle_venta` (
  `iddetalle_venta` BIGINT NOT NULL AUTO_INCREMENT,
  ...
  INDEX `fk_detalle_venta_venta_idx1` (`idarticulo` ASC),
...
CREATE TABLE IF NOT EXISTS `dbsistema`.`usuario_permiso` (
  `idusuario_permiso` BIGINT NOT NULL AUTO_INCREMENT,
  `idusuario` BIGINT NOT NULL,
